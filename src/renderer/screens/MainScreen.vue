...
<template>
  <v-container>
    <v-row>
      <v-col cols="12" class="d-flex ga-2 flex-column">
        <v-btn to="/sd-card-import"> {{ $t('sdCardImport.title') }}</v-btn>
        <v-btn> {{ $t('validateFolder.title') }}</v-btn>
        <v-btn> {{ $t('sync.title') }}</v-btn>
      </v-col>
    </v-row>
